---
title: "PMBOK® 8 y el nuevo examen PMP 2026: qué cambia"
description: "El 9 de julio de 2026 entra en vigor el nuevo examen PMP, con el ECO actualizado y alineado al PMBOK® 8. Si estás estudiando ahora, esto es lo que cambia."
pubDate: "2026-06-14"
...
Si estás estudiando para el PMP ahora mismo, esta fecha importa. Si ya tenés la certificación y trabajás con equipos que se preparan, también.

En este artículo explico qué cambia, qué se mantiene y cómo orientar la preparación a partir de julio.

---

## Qué es el ECO y por qué importa tanto
...
## Qué cambia con el nuevo ECO de julio 2026

El nuevo ECO mantiene los tres dominios que ya conocemos — **Personas, Proceso y Entorno de negocio** — pero modifica sus pesos:

| Dominio | ECO anterior (hasta julio 2026) | Nuevo ECO (desde julio 2026) |
|---|---|---|
| Personas | 42% | 33% |
| Proceso | 50% | 41% |
| Entorno de negocio | 8% | 26% |

El cambio más significativo es el salto del Entorno de negocio: pasa del 8% al 26%. Esto refleja una realidad que cualquier project manager experimentado ya conoce: los proyectos no existen en el vacío. La alineación estratégica, la entrega de valor y el impacto organizacional son parte del trabajo real.

Además, el nuevo examen incorpora:

- Mayor énfasis en **pensamiento sistémico y toma de decisiones** basada en contexto
- Integración explícita de **inteligencia artificial** como herramienta de apoyo en proyectos
- Nuevos tipos de preguntas: conjuntos de escenarios, interpretación visual y ítems de decisión encadenados
- Mayor peso de **enfoques ágiles e híbridos** en las preguntas de proceso

---

## Qué es el PMBOK® Guide Eighth Edition y cómo se relaciona con el examen

El PMBOK® Guide no es el examen. Pero sí es la referencia conceptual sobre la que PMI construye el ECO.
...
Antes de cambiar tu plan de estudio, conviene saber qué no cambia:

- El examen sigue siendo de **180 preguntas en 230 minutos**
- Los tres dominios (Personas, Proceso, Entorno de negocio) permanecen
- Los tipos de ítems existentes (opción múltiple, respuestas múltiples, emparejamiento, hotspot) continúan
- El énfasis en **aplicación práctica** sobre memorización de definiciones
- Los requisitos de elegibilidad para rendir el examen
...
Si ya terminaste tu estudio y estás en la etapa de práctica intensiva, el **Tomo III de la serie *Dirección de Proyectos: Guía de Preparación para la Certificación*** está diseñado exactamente para este momento.

Incluye 180 preguntas de simulacro con distribución ECO real (33% Personas / 41% Proceso / 26% Entorno de negocio), respuestas con justificación detallada, análisis de distractores y tabla de diagnóstico de brechas para orientar el repaso de último momento.
